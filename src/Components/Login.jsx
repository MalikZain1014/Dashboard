  ...
  return (
    <div className="bg-transparent flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        <h2 className="mt-6 text-center text-2xl font-bold leading-9 tracking-tight text-indigo-800 ">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div className="mt-2 relative">
                  ...
                  <button
                    type="button"
                    className="absolute inset-y-0 right-0 px-3 py-1.5 text-sm font-semibold leading-6 text-yellow-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-600"
